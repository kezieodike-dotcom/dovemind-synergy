...
`;
        ...
        class ShaderPass {
            ...
            constructor(props: Record<string, unknown>) {
                this.props = props || {};
                this.uniforms = (this.props.material as Record<string, unknown>)?.uniforms as Uniforms | undefined;
            }
            init(..._args: unknown[]) {
            ...
            update(..._args: unknown[]) {
                ...
                Common.renderer.setRenderTarget(this.props.output as THREE.WebGLRenderTarget | null || null);
        ...
        class ExternalForce extends ShaderPass {
            ...
            update(...args: unknown[]) {
                ...
                const cellScale = (props.cellScale || { x: 1, y: 1 }) as { x: number; y: number };
        ...
        class Pressure extends ShaderPass {
            ...
            update(...args: unknown[]) {
                const { vel, pressure } = (args[0] || {}) as { vel?: THREE.WebGLRenderTarget; pressure?: THREE.WebGLRenderTarget };
